...
scikit-learn Logistic Regression model. It employs a nested cross-validation
strategy for robust performance estimation and exports the final fitted models.
"""
...
DEFAULT_PARAM_GRID = {"C": [0.001, 0.01, 0.1, 1.0, 10.0], "penalty": ["l2"]}
...
def train_with_nested_cv(X: pd.DataFrame, y: pd.Series) -> LogisticRegression:
    ...
    Returns:
        LogisticRegression: The fitted model instantiated with the optimal hyperparameters.
    """
