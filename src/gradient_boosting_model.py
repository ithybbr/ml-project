...
scikit-learn GradientBoostingClassifier. It employs a nested cross-validation
...
def train_with_nested_cv(X: pd.DataFrame, y: pd.Series) -> GradientBoostingClassifier:
    ...
    Returns:
        GradientBoostingClassifier: The fitted model instantiated with the optimal hyperparameters.
    """
